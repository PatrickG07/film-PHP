...
?>
			<section class="center" a>
				<h2>Suchen</h2>
				<p>Hier ist die suche nach neuen Filmen</p>
				<form method="post">
					<?php
					...
					while ($row=$result->fetch_object()) {
						...
						?>
							<tr>
								...
								<td><a href="/film/filmdetile.php?fid=<?php echo $film_id; ?>">Detile</a></td>
							</tr>
						<?php
					}
					...
					<br><br><table border="1" cellpadding="5" cellspacing="0">
						...
						while ($row = $result->fetch_object()) {
							...
							<tr>
								...
								<td><?php echo $beschreibung; ?></td>
								<td><?php echo $dauer; ?></td>
								<td><a href="php/faforitphp.php?fid=<?php echo $film_id; ?>">Faforisiren</a></td>
								<td><a href="/film/filmdetile.php?fid=<?php echo $film_id; ?>">Detile</a></td>
							</tr>
							<?php
						}
